...
function syncUrl({ sports, markets, minRoi, bookmakers }: { sports: string[]; markets: string[]; minRoi: number; bookmakers: string[] }) {
...
function DropdownMulti({ options, values, onChange, label }: { options: { value: string; label: string }[]; values: string[]; onChange: (v: string[]) => void; label: string }) {
...
export default function Filters({ onChange }: { onChange?: (v: { sports: string[]; markets: string[]; minRoi: number; bookmakers: string[] }) => void } = {}) {
	...
	function handleChange(next: { sports?: string[]; markets?: string[]; minRoi?: number; bookmakers?: string[] }) {
